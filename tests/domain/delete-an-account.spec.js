...
describe('deleting an account', () => {
  ...
  const accountLouies = { cpf: '22222222222', name: 'Louies Doe', statement: [] }
  ...
  it('should deleting an existing account', async () => {
    expect(deleteAccount([...accounts], accountJohn)).toEqual([{ cpf: '22222222222', name: 'Louies Doe', statement: [] }])
  })
})
